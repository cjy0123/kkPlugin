 ...
 * 2 proto目录
 */
public class Proto2Go extends ProtoActionManager {
    /**
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        Map<String, Object> parseInfoMap = parseActionInfo(e, project, ProtoConst.PROTO_FOLDER_NAME);
        String pb2goBatName = "generateProto.bat";
...
//        protoManager.GenProto2Go(project, consoleView, parseInfoMap, pb2goBatName);
    ...
    public void update(AnActionEvent e) {
        ...
        if (!ActionPlaces.EDITOR_POPUP.equals(e.getPlace()) && !ActionPlaces.PROJECT_VIEW_POPUP.equals(e.getPlace())) {//只有在点击右键时才做过滤
            return;
        }
        Map<String, Object> parseInfoMap = parseActionInfo(e, project, ProtoConst.PROTO_FOLDER_NAME);
